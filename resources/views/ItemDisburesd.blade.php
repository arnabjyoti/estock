...
<div class="panel panel-default">
    <div class="panel-heading pl-3">Item Disbursed Reports</div>
    <div class="panel-body">

        <form name="operatorRpt" method="GET" action="/disbursedReport">
            <div class="row" style="padding:40px;">
                ...
                <div class="form-group col-lg-3 mt-4">
                    ...
                    <input type="text" class="form-control datepicker" data-date-format='yyyy-mm-dd' name="toDate" placeholder="To Date"  >
